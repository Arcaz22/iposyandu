...
import { AstraGrupBisnis, AstraPerusahaan, Desa, Event, Kabupaten, Kecamatan, PostgresModule, Posyandu, Provinsi, Puskesmas, SharedModule, SharedService } from '@app/shared';
...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([ Event, AstraGrupBisnis, AstraPerusahaan, Desa, Kabupaten, Kecamatan, Posyandu, Provinsi, Puskesmas ])
  ],
